                    ...
                    >
                        <ul>
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/petyshop.lb"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} Pety Shop
                                </span>
                            </div>
                        </div>
                    </div>
